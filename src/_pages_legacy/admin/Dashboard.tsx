...
function getStatusVariant(status?: string): "default" | "secondary" | "destructive" | "outline" {
  ...
  return statusVariant[key] ?? "secondary";
}
      ...
      <main className="ml-64 min-h-screen overflow-auto">
        <div className="p-6 lg:p-8 max-w-6xl mx-auto">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <h1 className="text-2xl lg:text-3xl font-bold text-[#07008A] tracking-tight">
              Dashboard
            </h1>
            <p className="text-muted-foreground mt-1">
              Overview of your hotel activity and recent bookings
            </p>
          </motion.div>
              ...
              <Card className="border-0 shadow-lg bg-white overflow-hidden">
                <CardContent className="p-0">
                  <div className="flex items-center gap-4 p-6">
                    <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-[#07008A]/10 text-[#07008A]">
                  ...
                  <div className="flex items-center gap-4 p-6">
                    ...
                    <div>
                      {loading ? (
                        ...
                        <p className="text-2xl font-bold text-[#07008A]">{confirmedCount}</p>
                      )}
                  ...
                  <div className="flex items-center gap-4 p-6">
                    ...
                    <div>
                      {loading ? (
                        ...
                        <p className="text-2xl font-bold text-[#07008A]">{pendingCount}</p>
                      )}
            ...
            <Card className="border-0 shadow-lg bg-white overflow-hidden">
              <CardHeader className="border-b bg-slate-50/50 px-6 py-4">
                <div className="flex items-center justify-between">
                  ...
                  <Link
                    to="/admin/bookings"
                    className="text-sm font-medium text-[#07008A] hover:underline flex items-center gap-1"
                  >
                    View all
                ...
                {loading ? (
                  ...
                  <div className="flex flex-col items-center justify-center py-16 px-6 text-center">
                    ...
                    <p className="text-sm text-muted-foreground mt-1 max-w-sm">
                      New reservations will appear here. Share your booking link to get started.
                    </p>
                  </div>
                ) : (
                        ...
                        {bookings.slice(0, 10).map((b, index) => (
                          ...
                          >
                            <td className="py-4 px-6">
                              <span className="font-mono text-sm font-medium text-[#07008A]">
                                {b.reference_number ?? "—"}
                              </span>
                            </td>
                            <td className="py-4 px-6">
