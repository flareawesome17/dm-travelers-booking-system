        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl border border-[#07008A]/10 overflow-hidden">
          ...
          <div className="p-8 sm:p-10">
            ...
            <div className="flex items-center gap-3 mb-8">
              ...
              <div>
                <h1 className="text-2xl font-bold tracking-tight text-[#07008A]">
                  Admin Login
                </h1>
                <p className="text-sm text-muted-foreground mt-0.5">
                  Sign in to manage D&M Travelers Inn
                </p>
              </div>
            </div>
            ...
            <form onSubmit={login} className="space-y-5">
              <div className="space-y-2">
                <Label htmlFor="admin-email" className="text-[#07008A]/90 font-medium">
                  Email
                </Label>
                <div className="relative">
                  ...
                  <Input
                    ...
                    className={cn(
                      "pl-10 h-11 rounded-lg border-[#07008A]/20 bg-muted/30",
                      "focus-visible:ring-[#07008A] focus-visible:border-[#07008A]/40"
                    )}
                    required
                  />
                </div>
              ...
              <div className="space-y-2">
                <Label htmlFor="admin-password" className="text-[#07008A]/90 font-medium">
                  Password
                </Label>
                <div className="relative">
                  ...
                  <Input
                    ...
                    className={cn(
                      "pl-10 pr-11 h-11 rounded-lg border-[#07008A]/20 bg-muted/30",
                      "focus-visible:ring-[#07008A] focus-visible:border-[#07008A]/40"
                    )}
                    required
                  />
              ...
              <Button
                ...
                className={cn(
                  ...
                  "bg-[#07008A] hover:bg-[#05006a] text-white",
                  "shadow-lg shadow-[#07008A]/25 hover:shadow-[#07008A]/30 transition-all"
                )}
              >
            ...
            <p className="mt-6 text-center">
              <Link
                to="/"
                className="inline-flex items-center gap-2 text-sm font-medium text-[#07008A] hover:text-[#05006a] transition-colors"
              >
